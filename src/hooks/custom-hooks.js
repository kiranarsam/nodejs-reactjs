...
/**
 * Build a Hook
 * We are fetching data in out 'Home' component and displaying it.
...
export const HomeCustomUseFetchHook = () => {
...
/**
 * Explained:
 * We have created a new function called 'useFetch' which contains all of the logic needed to fetch our data.
 *
 * We removed the hard-coded URL and replaced it with a 'url' variable that can be passed to the custom Hook.
 *
 * Lastly, we are returning our data from our Hook.
 *
 * We are using custom Hook 'useFetch' and utilizing it like any other Hook.
